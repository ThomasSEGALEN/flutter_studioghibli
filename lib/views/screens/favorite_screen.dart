    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content:
                const Text('Do you really want to delete your favorite list?'),
            actions: [
              IconButton(
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(
                _favoriteFilms[index].title,
                style: GoogleFonts.roboto(fontSize: 18),
              ),
              subtitle: Text(
                _favoriteFilms[index].releaseDate,
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  setState(
                    () {
                      _updateFavoriteState(_favoriteFilms[index].id, false);
