...
class _FilmScreenState extends State<FilmScreen> {
  ...
  _loadAndUpdateFavorites() {
    _favoriteStorage.loadFavorites().then(
      (List<Film> value) {
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            elevation: 2,
            child: ListTile(
              leading: Image.network(FilmScreen.refFilms[index].film.image),
              title: Text(
                FilmScreen.refFilms[index].film.title,
              ...
              trailing: IconButton(
                ...
                icon: FaIcon(
                    ...
                    color: Theme.of(context).brightness == Brightness.light
                        ? Colors.deepPurple
                        : Colors.white,
                    semanticLabel: FilmScreen.refFilms[index].isFavorite
                        ? 'Liked'
                        : 'Not Liked'),
                onPressed: () {
                  setState(
                    () {
                      _updateFavoriteState(FilmScreen.refFilms[index].film.id,
                          !FilmScreen.refFilms[index].isFavorite);
                    },
                  );
                },
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        DetailScreen(film: FilmScreen.refFilms[index].film),
                  ),
                );
              },
            ),
